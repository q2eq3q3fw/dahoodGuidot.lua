...
Acmode.Name = "Acmode"
Acmode.Parent = Main
Acmode.BackgroundColor3 = Color3.fromRGB(43, 43, 43)
...
TextBox.BorderColor3 = Color3.fromRGB(43, 43, 43)
...
TextLabel_3.BackgroundColor3 = Color3.fromRGB(43, 43, 43)
...
local localPlayer     = game:GetService("Players").LocalPlayer;
		...
		elseif game.Players[TargetPlr].Character.BodyEffects['K.O'].Value == true then
			wait(0) local A_1 = "[Am] " .. TargetPlr .. " Is Already Eliminated." local A_2 = "All" local Event = game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest Event:FireServer(A_1, A_2)
			game.StarterGui:SetCore("SendNotification", {
				Title = "DISCORD.GG/";
